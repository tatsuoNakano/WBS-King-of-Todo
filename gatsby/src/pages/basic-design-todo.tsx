...
const CATEGORY_NAME_KEY = "basic-design-category-names"; // 表示名用

const BasicDesighTodo: React.FC = () => {
                ...
                <Row>
                    {[0, 1, 2, 3].map((index) => (
                        <Col key={index} md={3} className="mb-4">
                            ...
                            <TodoListWithMarkdownExport storageKey={`basic-${index + 1}`} />
                        </Col>
                    ))}
                </Row>
            </Container>
...
export default BasicDesighTodo;
