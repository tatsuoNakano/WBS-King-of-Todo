...
const CATEGORY_NAME_KEY = "build-deploy-category-names"; // 表示名用

const BuildDeployTodo: React.FC = () => {
                ...
                <Row>
                    {[0, 1, 2, 3].map((index) => (
                        <Col key={index} md={3} className="mb-4">
                            ...
                            <TodoListWithMarkdownExport storageKey={`build-${index + 1}`} />
                        </Col>
                    ))}
                </Row>
            </Container>
...
export default BuildDeployTodo;
