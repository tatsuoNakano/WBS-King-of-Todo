...
const CATEGORY_NAME_KEY = "detailed-design-category-names"; // 表示名用

const DetailedDesighTodo: React.FC = () => {
                ...
                <Row>
                    {[0, 1, 2, 3].map((index) => (
                        <Col key={index} md={3} className="mb-4">
                            ...
                            <TodoListWithMarkdownExport storageKey={`detailed-${index + 1}`} />
                        </Col>
                    ))}
                </Row>
            </Container>
...
export default DetailedDesighTodo;
